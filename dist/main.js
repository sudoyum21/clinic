...
/* harmony import */ var _service_http_interceptor_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./service/http-interceptor-service */ "./src/app/service/http-interceptor-service.ts");
...
/* harmony import */ var _service_http_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./service/http-service */ "./src/app/service/http-service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            providers: [_service_http_service__WEBPACK_IMPORTED_MODULE_7__["HttpService"], {
                    provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HTTP_INTERCEPTORS"],
                    useClass: _service_http_interceptor_service__WEBPACK_IMPORTED_MODULE_4__["HttpInterceptorService"],
                    multi: true
                }],
...
var FormComponent = /** @class */ (function () {
    function FormComponent(httpService) {
    ...
    FormComponent.prototype.getForm = function () {
        this.httpService.getFoods().subscribe(function (data) {
            console.log(data);
        });
    };
    FormComponent = __decorate([
        ...
        __metadata("design:paramtypes", [src_app_service_http_service__WEBPACK_IMPORTED_MODULE_1__["HttpService"]])
    ], FormComponent);
...
module.exports = __webpack_require__(/*! C:\Users\Lam\Desktop\perso\clinic\src\main.ts */"./src/main.ts");
